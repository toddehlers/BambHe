      MODULE direct_procedures_hexdisc
      IMPLICIT NONE
...
C global variables 
      ...
      REAL(KIND=r8) :: tol,tmin,tmax,dt,amp,side,pi,init_conc
      REAL(KIND=r8) :: D0,Ea,Gc,tot_area,tot_prod_rate,L,Prate
      ...
      END MODULE direct_procedures_hexdisc