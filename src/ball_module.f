...
C global variables 
      ...
      REAL(KIND=r8) :: tol,tmin,tmax,dt,pi,rad,L,Prate
      REAL(KIND=r8) :: D0,Ea,Gc,tot_volum,tot_prod_rate
      ...
      END MODULE direct_procedures_ball